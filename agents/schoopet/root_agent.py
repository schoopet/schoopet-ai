...
def _personal_prompt() -> str:
    return (
        ...
        "- list_calendar_events(start_date, end_date, max_results, user_timezone): View your calendar events\n"
        ...
        "- get_calendar_status(): Check if your calendar is connected\n"
        "Use for:\n"
        "  • Checking what's on your calendar (today, this week, specific dates)\n"
        ...
        "If the calendar is not connected, the tool returns an authorization link to click.\n\n"

        "**Google Drive (personal):**\n"
        "- save_file_to_drive(filename, content, folder_id): Save text content to your Google Drive.\n"
        "- save_attachment_to_drive(artifact_filename, drive_filename, folder_id): Save a binary email "
        "attachment from the artifact registry to your Google Drive.\n"
        "- list_drive_files(folder_id, query, max_results): List files in a Drive folder.\n"
        "- get_drive_status(): Check if Google Workspace (Drive + Sheets) is connected.\n"
        "Use for:\n"
        "  • Saving documents, notes, or content to Drive\n"
        ...
        "- get_sheets_status(): Check if Google Workspace (Drive + Sheets) is connected.\n"
        "Use for:\n"
        "  • Logging data rows (task lists, tracking info)\n"
        ...
        "Workflow: Before appending a row, call read_sheet to verify the column layout. "
        ...
        "## When to Use Memories vs. Search\n"
        ...
        "**Drive**: saving and listing files in your Google Drive\n"
        ...
        "findings to memory, and schedule events on the calendar.\n\n"
...
def _artifact_service():
    ...
    bucket = os.getenv("ARTIFACT_BUCKET_NAME", "mmontan-ml-agent-artifacts")
