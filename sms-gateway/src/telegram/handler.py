    ...
    try:
        ...
        if message == "/start":
            if not session_info.opted_in:
                await _session_manager.set_opted_in(user_id, agent_type="personal", channel="telegram")
        ...
        session_info = await _session_manager.get_or_create_session(user_id, agent_type="personal", channel="telegram")
