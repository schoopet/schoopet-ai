    ...
    try:
        ...
        if not session_info.opted_in:
            if normalized_message == "YES":
                ...
                await _session_manager.set_opted_in(phone_number, agent_type="personal", channel=channel.value)
        ...
        session_info = await _session_manager.get_or_create_session(phone_number, agent_type="personal", channel=channel.value)
