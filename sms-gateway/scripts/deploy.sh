...
echo "  Telegram: \$(terraform -chdir=$TF_DIR output -raw sms_gateway_url)/webhook/telegram"
echo "  Slack:    \$(terraform -chdir=$TF_DIR output -raw sms_gateway_url)/webhook/slack"
echo "=========================================="
